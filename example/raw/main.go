...
func init() {
	...
	flag.StringVar(&group, "group", "tuantest", "Kafka consumer group definition")
	flag.StringVar(&version, "version", sarama.DefaultVersion.String(), "Kafka cluster version")
	flag.StringVar(&topics, "topics", "evt.kafka.user", "Kafka topics to be consumed, as a comma separated list")
